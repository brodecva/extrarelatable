...
/**
 * Spring-specific definitions of qualifiers used to change the injected classes
 * based on the configuration provided as system properties or in a property
 * file.
 * 
