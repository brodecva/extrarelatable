...
/**
 * Select the best (most discriminating) {@link Subcontext} from candidates for an input {@link Partition}.
 * 
...
public interface SubcontextMatcher {
	/**
	 * Selects the best (most discriminating) {@link Subcontext} from the candidates for the input {@link Partition}.
	 * 
	 * @param candidates candidate {@link Subcontext}s
	 * @param inputPartition input partition
