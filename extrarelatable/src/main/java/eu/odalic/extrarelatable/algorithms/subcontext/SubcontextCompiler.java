...
public interface SubcontextCompiler {
	/**
	 * Creates a set of candidate {@link Subcontext}s from the input
	 * {@link Partition}.
	 * 
	 * @param partition
	 *            input partition
	 * @param availableContextColumnIndices
	 *            indices of remaining columns able to provide row context
	 * @param table
	 *            the source table
