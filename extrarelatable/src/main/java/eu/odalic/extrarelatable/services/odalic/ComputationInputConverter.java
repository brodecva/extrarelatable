...
/**
 * Converter of the ERT input format to the one recognized by Odalic ({@link ComputationInputValue}).
 * 
...
public interface ComputationInputConverter {
	 ...
	 * @param random random generator used to sample the table rows when exceeding the limit
