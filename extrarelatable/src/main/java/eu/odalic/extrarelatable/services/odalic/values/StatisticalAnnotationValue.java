...
public final class StatisticalAnnotationValue {
	 ...
	 */
	public void setComponent(final Map<? extends String, ? extends ComponentTypeValue> component) {
	 ...
	 */
	public void setPredicate(final Map<? extends String, ? extends Set<? extends EntityCandidateValue>> predicate) {
		checkNotNull(predicate);

		this.predicate = predicate.entrySet().stream()
				.collect(ImmutableMap.toImmutableMap(e -> e.getKey(), e -> ImmutableSet.copyOf(e.getValue())));
	}

	@Override
	public String toString() {
		return "StatisticalAnnotationValue [component=" + this.component + ", predicate=" + this.predicate + "]";
	}
}
