...
public final class DefaultFormatAdapter implements FormatAdapter {
	...
	public CSVFormat convert(final Format applicationFormat) {
		CSVFormat format = CSVFormat.newFormat(applicationFormat.getDelimiter()).withAllowMissingColumnNames()
				.withIgnoreEmptyLines(applicationFormat.isEmptyLinesIgnored())
