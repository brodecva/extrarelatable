...
import eu.odalic.extrarelatable.util.Characters;
...
public final class Format implements Serializable {
	...
	/**
	 * Creates a default format, which assumes UTF-8 character set, semicolon
	 * delimiters, the header to be present and the system line separator.
	 */
	public Format() {
	 ...
	 *            use this quote character
	 * @param escapeCharacter
	 *            use this escaping character
	 * @param commentMarker
	 *            use this comment marker
	 */
	 ...
	 *            use this comment marker
	 * @param lineSeparator
	 *            use this line separator for generating new CSV file
	 */
	public Format(final Charset charset, final char delimiter, final boolean emptyLinesIgnored,
			final @Nullable Character quoteCharacter, final @Nullable Character escapeCharacter,
			final @Nullable Character commentMarker, final String lineSeparator) {
		checkNotNull(charset, "The charset cannot be null!");
		checkNotNull(lineSeparator, "The lineSeparator cannot be null!");

		checkArgument(!Characters.isLineBreak(delimiter), "The delimiter is a line break character.");
		checkArgument(!Characters.isLineBreak(quoteCharacter), "The quote character is a line break character.");
		checkArgument(!Characters.isLineBreak(escapeCharacter), "The escape character is a line break character.");
		checkArgument(!Characters.isLineBreak(commentMarker), "The comment marker is a line break character.");
	...
	public int hashCode() {
		...
		result = (prime * result) + ((this.escapeCharacter == null) ? 0 : this.escapeCharacter.hashCode());
		result = (prime * result) + ((this.quoteCharacter == null) ? 0 : this.quoteCharacter.hashCode());
