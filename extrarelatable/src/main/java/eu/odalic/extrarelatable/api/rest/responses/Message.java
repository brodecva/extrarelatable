...
public final class Message {
	...
	/**
	 * Utility method that wraps the message into a JSON response and assigns it the
	 * provided {@link StatusType}.
	 *
	 * @param statusType
	 *            status type
	 * @param uriInfo
	...
	/**
	 * Utility method that wraps the message into a JSON response and assigns it the
	 * provided {@link StatusType} and location header content.
	 *
	 * @param statusType
	 *            status type
	 * @param location
	 ...
	 */
	@XmlTransient
	public Response toResponse(final StatusType statusType, final URL location, final UriInfo uriInfo) {
		Preconditions.checkNotNull(statusType, "The statusType cannot be null!");
	...
	/**
	 * Utility method that wraps the message into a JSON response builder and
	 * assigns it the provided {@link StatusType}.
	 *
	 * @param statusType
	 *            status type
	 * @param uriInfo
