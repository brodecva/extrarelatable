...
public final class EntityValue implements Comparable<EntityValue>, Serializable {
	...
	/**
	 * @param prefixed
	 *            the prefixed form of the resource to set
	 */
	 ...
	 * @see java.lang.String#compareTo(String) for the definition of resource ID
	 *      comparison
	 */
	@Override
	...
	public String toString() {
		return "EntityValue [resource=" + this.resource + ", label=" + this.label + ", prefixed=" + this.prefixed
				+ ", prefix=" + this.prefix + ", tail=" + this.tail + "]";
	}
}
