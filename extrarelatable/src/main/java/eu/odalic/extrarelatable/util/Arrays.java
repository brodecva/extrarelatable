...
public final class Arrays {
	 ...
	 *             if either of dimensions of the matrix is zero, if the type of
	 *             elements is Void.TYPE, or if the number of any dimension of the
	 *             matrix exceeds 255.
	 *
	 * @param <T>
	 *            type of elements
	 */
	public static <T> T[][] deepCopy(final Class<T> type, final T[][] matrix) throws IllegalArgumentException {
