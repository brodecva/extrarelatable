...
public interface ParsedTable {
	/**
	 * Provides the table headers. The list of headers is always present (as we
	 * operate on tables with at least one row) and it is always the first row.
	 * 
	...
	/**
	 * @return the list of rows from top to bottom of the table in normal
	 *         orientation
	 */
	List<List<String>> getRows();

	/**
	 * @return the list of columns from left to right of the table in normal
	 *         orientation
	 */
